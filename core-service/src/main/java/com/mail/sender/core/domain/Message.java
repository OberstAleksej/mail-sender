...
public class Message implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(id, message.id) && Objects.equals(uniqueMessage, message.uniqueMessage)
        && Objects.equals(groupUsers, message.groupUsers) && Objects.equals(file, message.file)
        && typeFile == message.typeFile && Objects.equals(messageText, message.messageText)
        && Objects.equals(date, message.date) && status == message.status && Objects.equals(
        dateStatus, message.dateStatus) && Objects.equals(errors, message.errors) && Objects.equals(
        tags, message.tags) && Objects.equals(templateId, message.templateId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, uniqueMessage, groupUsers, file, typeFile, messageText, date, status, dateStatus, errors,
        tags, templateId);
  }
